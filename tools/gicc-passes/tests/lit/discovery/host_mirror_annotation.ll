; Phase B: a kernel annotated GICC_KERNEL_HOST_MIRROR(transfers) that
; loops over the host-mirrored array and issues one gicc::put per entry,
; gated by `transfers[i].peer_recv_addr != null ? continue : put`. The
; device-discovery pass should:
;   - flag params[1] (transfers) as host_mirrored
;   - capture each ArgRef as FieldLoad of formal 1
;   - capture the guard as FieldNotNull
;
...
; RUN: cat %t.metadir/halo_kernel.json | %FileCheck %s

target triple = "amdgcn-amd-amdhsa"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-p7:160:256:256:32-p8:128:128-p9:192:256:256:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7:8:9"

; struct Desc { i32 peer; i32 dst_buf; i64 dst_off; ptr peer_recv_addr; }
; sizeof = 4 + 4 + 8 + 8 = 24, alloc = 24.  Field offsets: 0, 4, 8, 16.
%struct.Desc = type { i32, i32, i64, ptr }

; gicc::put(DeviceCtx*, peer, dst_buf, dst_off, src_buf, src_off, size, lane)
declare void @_ZN4gicc3putEPN4gicc9DeviceCtxEiimimmi(
    ptr, i32, i32, i64, i32, i64, i64, i32)

; --- annotation: transfers (formal 1) is host-mirrored ---
...
loop.body:
  ; IPC-skip guard: load peer_recv_addr (field 3), compare to null.
...
; --- check JSON content (LLVM emits keys alphabetically) ---
; CHECK: "kernel_simple": "halo_kernel"
;
; Op's guard is FieldNotNull pointing at the peer_recv_addr field
; (offset 16, ptr) of the host-mirrored transfers[] array.
; CHECK: "guard"
; CHECK-NEXT: "field"
; CHECK-NEXT: "base_formal": 1
; CHECK: "field_offset": 16
; CHECK: "field_type": "ptr"
; CHECK: "kind": "field_load"
; CHECK: "struct_size": 24
; CHECK: "kind": "field_not_null"
;
; CHECK: "loop"
; CHECK-NEXT: "in_loop": true
;
; The 'transfers' formal (idx=1) is flagged as host_mirrored.
