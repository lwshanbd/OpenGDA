...
echo "  FI_MR_CACHE_MAX_COUNT=0 srun -N 2 -n 2 --ntasks-per-node=1 -t 2 $BUILD_DIR/benchmark"
echo "  FI_MR_CACHE_MAX_COUNT=0 srun -N 4 -n 4 --ntasks-per-node=1 -t 2 $BUILD_DIR/mm_minimal"
echo "  FI_MR_CACHE_MAX_COUNT=0 srun -N 2 -n 2 --ntasks-per-node=1 -t 2 $BUILD_DIR/barrier_test"
echo "  FI_MR_CACHE_MAX_COUNT=0 srun -N 2 -n 2 --ntasks-per-node=1 -t 2 $BUILD_DIR/am_pingpong"
